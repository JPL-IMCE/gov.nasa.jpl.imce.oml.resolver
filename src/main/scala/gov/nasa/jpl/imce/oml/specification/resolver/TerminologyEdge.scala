...
object TerminologyEdge {
  ...
  = tAxiom match {
    case tx: resolver.impl.TerminologyExtensionAxiom =>
      tx.copy(extendingTerminology = thatSource)
    case tx: resolver.impl.ConceptDesignationTerminologyAxiom =>
      thatSource match {
    ...
    case tx: resolver.impl.TerminologyNestingAxiom =>
      thatSource match {
        case thatGraph: resolver.api.TerminologyGraph =>
    ...
    case tx: resolver.impl.BundledTerminologyAxiom =>
      thatSource match {
