...
case class InstanceRelationshipUniversalRangeRestriction private[impl] 
	(
	 override val uuid: resolver.api.taggedTypes.InstanceRelationshipUniversalRangeRestrictionUUID,
...
extends resolver.api.InstanceRelationshipUniversalRangeRestriction
  ...
  with ElementCrossReferenceTuple
{
  ...
  ()(implicit extent: resolver.api.Extent)
	  ...
	  = {
	    extent.descriptionBoxOfInstanceRelationshipUniversalRangeRestriction.get(this)
	  }
  ...
  override def canEqual(that: scala.Any): scala.Boolean = that match {
	  case _: InstanceRelationshipUniversalRangeRestriction => true
 	  case _ => false
  }
